...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.welcometothegame3.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Welcome to the Game 3 Wiki",
    description: "Read the Terms of Service for Welcome to the Game 3 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Welcome to the Game 3 Wiki",
      title: "Terms of Service - Welcome to the Game 3 Wiki",
      description: "Terms and conditions for using Welcome to the Game 3 Wiki.",
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: "Welcome to the Game 3 Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Welcome to the Game 3 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Welcome to the Game 3 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Welcome to the Game 3 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Welcome to the Game 3 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Welcome to the Game 3". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and survival strategies</li>
              <li>Puzzle solutions and clue guides</li>
            ...
            <p>
              <strong>Important:</strong> Welcome to the Game 3 Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Welcome to the Game 3. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Welcome to the Game 3 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Welcome to the Game 3. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, WELCOME TO THE GAME 3 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Welcome to the Game 3 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@welcometothegame3.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@welcometothegame3.wiki</a>
            </p>
            <p>
